...
class While extends Statement {
	...
	// The M function is implemented by a while-loop instead of recursion to avoid
	// runtime stack buildup.
...

	{
		...
		while (exprVal != null) {
			if (exprVal instanceof BoolVal)
				...
				System.out.println("Error: Boolean expression of while statement evaluated to non-Boolean value: "
						+ exprVal.toString());
				return;
			}
		}
