...
public abstract class Parser extends LexAnalyzer {
    ...
    public static RightSide rightSide() { // <right side> --> <array constructor> | <expr right side>
        // <expr right side> --> <expr>
    ...
    public static ArrayConstructor arrayConstructor() {    // <array constructor> --> "new" "[" <E list> "]"
    ...
    public static Cond cond() {   // <cond> --> "if" "(" <expr> ")" <statement> [ "else" <statement> ]
        getToken(); // flush "if"
        if (state == State.LParen) {
            getToken();
            Expr expr = expr();
    ...
    public static While while_() {// <while> --> "while" "(" <expr> ")" <statement>
    ...
    public static Block block() {   // <block> --> "{" <s list> "}"
        getToken(); // flush "{"
        SList sList = sList();
        if (state == State.RBrace) {
            getToken();
    ...
    public static FunCall funCall(Id id) {
        // id is the function name extracted.
    ...
    public static ExprList exprList() {// <expr list> --> <expr> { "," <expr> }
    ...
    public static Print print() {// <print> --> "print" <expr> ";"
    ...
    public static Expr expr() {// <expr> --> <boolTerm> { "||" <boolTerm> }
    ...
    public static BoolTerm boolTerm() { // <boolTerm> --> <boolPrimary> { "&&" <boolPrimary> }
    ...
    public static BoolPrimary boolPrimary() {// <boolPrimary> --> <E> [ <comp op> <E> ]
        // <comp op> --> "<" | "<=" | ">" | ">=" | "==" | "!="
        E e1 = E();
        if (state.isCompOp()) {
            State compOp = state;
    ...
    public static Term term() {// <term> --> <primary> { (*|/) <primary> }
    ...
    public static Primary primary() {// <primary> --> <var primary> | <int> | <float> | <floatE> | "(" <expr> ")" | - <primary> | ! <primary> | <fun call primary>
        // <var primary> --> <var>
        switch (state) {
            case Id:
                Id id = new Id(t);
